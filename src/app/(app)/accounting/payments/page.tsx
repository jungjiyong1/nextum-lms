import { AccountingPaymentsRoute } from '@/app-routes/AccountingRoute';
...
export default async function Page({ searchParams }: { searchParams: Promise<{ month?: string | string[] }> }) {
  ...
  if (requestedMonth !== month) redirect(accountingHref('payments', month));
  return <AccountingPaymentsRoute initialMonth={month} />;
}
