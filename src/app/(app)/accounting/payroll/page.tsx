import { AccountingPayrollRoute } from '@/app-routes/AccountingRoute';
...
export default async function Page({ searchParams }: { searchParams: Promise<{ month?: string | string[] }> }) {
  ...
  if (requestedMonth !== month) redirect(accountingHref('payroll', month));
  return <AccountingPayrollRoute initialMonth={month} />;
}
